<template>
    <div id="uploadPaperPage">
        ...
        <div id="operationLinks">
            <el-button @click="handleMultipleUpload" type="text" icon="el-icon-upload">批量上传试卷</el-button>
        </div>
            ...
            <el-table :data="paperList.slice((currentPage-1)*pageSize,currentPage*pageSize)" style="width:100%" stripe 
                ...
                <el-table-column label="操作" fixed="right">
                    <template slot-scope="scope">
                        <el-button @click="handleUpload(scope.$index,scope.row)" type="text" size="medium" icon="el-icon-upload"></el-button>
