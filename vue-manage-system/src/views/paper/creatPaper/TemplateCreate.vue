<template>
    <div id="TemplateCreatePaperPage">
        <!--模板查询表单-->
            ...
            <el-table :data="templateList.slice((currentPage-1)*pageSize,currentPage*pageSize)" style="width:100%" stripe 
                ...
                <el-table-column label="操作" fixed="right">
                    <template slot-scope="scope">
                        <el-button @click="handleTemplateCreatePaper(scope.$index,scope.row)" type="text" size="small">组卷</el-button>
                        <el-button @click="handleGetTemplateDetails(scope.$index,scope.row)" type="text" size="small">详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
