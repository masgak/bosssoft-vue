<template>
    <div id="templateManagePage">
        ...
        <div id="operationLinks">
            <el-button @click="handleMultipleDelete" type="text" icon="el-icon-delete">批量删除</el-button>
        </div>
            ...
            <el-table :data="templateList.slice((currentPage-1)*pageSize,currentPage*pageSize)" style="width:100%" stripe 
                ...
                <el-table-column label="操作" fixed="right">
                    <template slot-scope="scope">
                        <el-button @click="handleDelete(scope.$index,scope.row)" type="text" size="medium" icon="el-icon-delete"></el-button>
                        <el-button @click="handleGetTemplateDetails(scope.$index,scope.row)" type="text" size="medium" icon="el-icon-view"></el-button>
                        <el-button @click="handleEdit(scope.$index,scope.row)" type="text" size="medium" icon="el-icon-edit"></el-button>
                    </template>
                </el-table-column>
            </el-table>
