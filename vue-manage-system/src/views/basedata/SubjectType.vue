...
<template>
  <div>
    ...
    <div style="float:left">
      <el-button type="text" class="el-icon-plus" style="font-size: 15px" @click="showAddSubjectType">增加</el-button>
      <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <el-button type="text" class="el-icon-delete" style="font-size: 15px" @click="deleteSubjectTypes">批量删除</el-button>
      <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <el-button type="text" class="el-icon-edit" style="font-size: 15px" @click="checkAndShowEditSubjectType">修改</el-button>
      <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
  ...
  <!-- 添加/修改题目类型弹窗 -->
    <div>
      <el-form :model="subjectType" :label-position="labelPosition" :rules="rules" ref="addSubjectType" style="margin: 0px;
      padding: 0px;">
        <!-- close-on-click-modal 点击空白处是否关闭弹窗 -->
        <el-dialog :title="dialogTitle" style="padding: 0px;" :close-on-click-modal="false" 
        :visible.sync="dialogSubjectType" width="50%">
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button size="mini" type="primary" @click="addSubjectType()">保 存</el-button>
        </span>
        </el-dialog>
      </el-form>
    </div>
    ...
    <!-- 导出文件对话框 -->
    <div>
      <el-dialog title="导出" :visible.sync="dialogDownload" width="20%" :before-close="handleClose" center>
...
export default {
  data() {
    return {
      ...
      //前端校验
      rules:{
        name:[{required:true, message:'题目类型名称必填', trigger:'blur'}],
